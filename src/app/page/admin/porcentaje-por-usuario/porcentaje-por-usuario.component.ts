...
@Component({
  selector: 'app-porcentaje-por-usuario',
  templateUrl: './porcentaje-por-usuario.component.html',
  styleUrls: ['./porcentaje-por-usuario.component.css']
})
export class PorcentajePorUsuarioComponent implements OnInit {
