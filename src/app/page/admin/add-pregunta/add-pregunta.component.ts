...
export class AddPreguntaComponent implements OnInit {
  ...
  pregunta:any = {
    ...
    opcion4 : '', 
    respuesta : '',
    estadoDeCalificacionDeLosCentros: '',                     //txd
    observacion: '',
    evaluacion: '',
 ...
 /*   if(this.pregunta.contenido.trim() == '' || this.pregunta.contenido == null){
    ...
    */
    if(this.pregunta.observacionesEspecialistaDeOperaciones.trim() == '' || this.pregunta.observacionesEspecialistaDeOperaciones == null){
      return;
    }
    if(this.pregunta.evaluacion.trim() == '' || this.pregunta.evaluacion == null){
      return;
    }
    if(this.pregunta.observacion.trim() == '' || this.pregunta.observacion == null){
      return;
    }
    if(this.pregunta.estadoDeCalificacionDeLosCentros.trim() == '' || this.pregunta.estadoDeCalificacionDeLosCentros == null){
      return;
    }
 ...
 */       
        ...
        this.pregunta.estadoDeCalificacionDeLosCentros ='';                     //txd
        this.pregunta.observacion = '';
        this.pregunta.evaluacion = '';
        this.pregunta.observacionesEspecialistaDeOperaciones = '';
